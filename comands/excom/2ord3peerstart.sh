...
sleep 10
#
echo "*** Install Chaincode in peer2.org1.example.com"
docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" -e "CORE_PEER_ADDRESS=peer2.org1.example.com:7051" cli peer chaincode install -n fabcar -v 1.0 -p "$CC_SRC_PATH" -l "$LANGUAGE"
sleep 10
#
...
sleep 10
#
echo "*** Invoking chaincodes from peer0"
...
sleep 10
#
echo "*** Invoking chaincodes from peer1"
docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp"  -e "CORE_PEER_ADDRESS=peer1.org1.example.com:7051" cli peer chaincode invoke -o orderer0.example.com:7050 -C mychannel -n fabcar -c '{"function":"queryAllCars","Args":[""]}'
#
echo "*** Invoking chaincodes from peer2"
docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp"  -e "CORE_PEER_ADDRESS=peer2.org1.example.com:7051" cli peer chaincode invoke -o orderer0.example.com:7050 -C mychannel -n fabcar -c '{"function":"queryAllCars","Args":[""]}'
#
